...
// -------------------------------------------------------------------------
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6 whitespace-nowrap py-4">
    <span>AI-Powered Consultation</span>{" "}
    <span className="text-primary/60">✦</span>
    <span>Personalized Recommendations</span>{" "}
    <span className="text-secondary/60">✦</span>
    <span>Circular 24/2020 Compliant</span>{" "}
    <span className="text-primary/60">✦</span>
      ...
      >
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="absolute top-12 left-0 w-full overflow-hidden border-y border-border/50 bg-background/60 backdrop-blur-md py-4 z-10 -rotate-2 scale-110 shadow-2xl">
            <div className="flex w-max animate-footer-scroll-marquee text-xs md:text-sm font-bold tracking-[0.3em] text-cyan-900 uppercase">
              <MarqueeItem />
              <MarqueeItem />
            </div>
          </div>
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            <h2
              ref={headingRef}
              className="text-5xl md:text-8xl font-black bg-gradient-to-b from-cyan-600 to-cyan-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(56,189,248,0.3)] tracking-tighter mb-12 text-center"
            >
              Ready to begin?
            </h2>
